...
func (m *MockGitlabClientIface) AddGroupMember(gid any, opt *go_gitlab.AddGroupMemberOptions, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.GroupMember, *go_gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{gid, opt}
...
func (mr *MockGitlabClientIfaceMockRecorder) AddGroupMember(gid, opt any, options ...any) *gomock.Call {
...
func (mr *MockGitlabClientIfaceMockRecorder) BlockUser(user any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) CreateGroup(opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) CreateUser(opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{opt}, options...)
...
func (m *MockGitlabClientIface) DeactivateUser(user int, options ...go_gitlab.RequestOptionFunc) error {
	m.ctrl.T.Helper()
	varargs := []any{user}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (mr *MockGitlabClientIfaceMockRecorder) DeactivateUser(user any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{user}, options...)
...
func (mr *MockGitlabClientIfaceMockRecorder) DeleteGroup(gid any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGitlabClientIface) DeleteSharedProjectFromGroup(pid any, groupID int, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) DeleteSharedProjectFromGroup(pid, groupID any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGitlabClientIface) EditGroupMember(gid any, user int, opt *go_gitlab.EditGroupMemberOptions, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.GroupMember, *go_gitlab.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) EditGroupMember(gid, user, opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{gid, user, opt}, options...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditGroupMember", reflect.TypeOf((*MockGitlabClientIface)(nil).EditGroupMember), varargs...)
}

// ListGroupMembers mocks base method.
func (m *MockGitlabClientIface) ListGroupMembers(gid any, opt *go_gitlab.ListGroupMembersOptions, options ...go_gitlab.RequestOptionFunc) ([]*go_gitlab.GroupMember, *go_gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{gid, opt}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (mr *MockGitlabClientIfaceMockRecorder) ListGroupMembers(gid, opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{gid, opt}, options...)
...
func (mr *MockGitlabClientIfaceMockRecorder) ListGroups(opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{opt}, options...)
...
func (mr *MockGitlabClientIfaceMockRecorder) ListProjects(opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{opt}, options...)
...
func (mr *MockGitlabClientIfaceMockRecorder) ListUsers(opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{opt}, options...)
...
func (m *MockGitlabClientIface) ModifyUser(user int, opt *go_gitlab.ModifyUserOptions, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.User, *go_gitlab.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) ModifyUser(user, opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockGitlabClientIface) RemoveGroupMember(gid any, user int, opt *go_gitlab.RemoveGroupMemberOptions, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{gid, user, opt}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (mr *MockGitlabClientIfaceMockRecorder) RemoveGroupMember(gid, user, opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{gid, user, opt}, options...)
...
func (m *MockGitlabClientIface) ShareProjectWithGroup(pid any, opt *go_gitlab.ShareWithGroupOptions, options ...go_gitlab.RequestOptionFunc) (*go_gitlab.Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{pid, opt}
	for _, a := range options {
		varargs = append(varargs, a)
...
func (mr *MockGitlabClientIfaceMockRecorder) ShareProjectWithGroup(pid, opt any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGitlabClientIfaceMockRecorder) UnblockUser(user any, options ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{user}, options...)
