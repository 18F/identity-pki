...
test_aws_vault_config_file_exists() {
	...
	explanation=""
	wiki_reference="https://gitlab.login.gov/lg/identity-devops/-/wikis/Setting-Up-your-Login.gov-Infrastructure-Configuration#configure-aws-vault-with-aws-access-keys"
...
test_aws_vault_config_sandbox_profiles() {
	...
	explanation=""
	wiki_reference="https://gitlab.login.gov/lg/identity-devops/-/wikis/Setting-Up-your-Login.gov-Infrastructure-Configuration#finish-aws-vault-setup"
...
test_aws_vault_config_ca_bundle() {
	...
	wiki_reference="https://gitlab.login.gov/lg/identity-devops/-/wikis/Working-around-%5BSSL:-CERTIFICATE_VERIFY_FAILED%5D-error"
