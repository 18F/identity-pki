...
COPY dockerfiles/devops_terraform_plan_verify.sh /usr/local/bin/devops_terraform_plan_verify.sh
...
USER deployuser
ENTRYPOINT ["/usr/local/bin/devops_terraform_plan_verify.sh"]
