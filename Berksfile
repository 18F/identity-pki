...
# use filebeat fork temporarily during chef 12=>13 upgrade
cookbook 'filebeat', '~> 0.4.9', git: 'https://github.com/18F/chef-filebeat', branch: 'login.gov-fix-chef-upgrade'
