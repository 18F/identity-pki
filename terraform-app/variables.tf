...
variable "no_proxy_hosts" { default = "localhost,127.0.0.1,169.254.169.254,169.254.169.123,.login.gov.internal,s3-${var.region}.amazonaws.com,s3.${var.region}.amazonaws.com,s3.dualstack.${var.region}.amazonaws.com,ec2.${var.region}.amazonaws.com,kms.${var.region}.amazonaws.com" }
