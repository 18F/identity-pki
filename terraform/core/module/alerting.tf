data "aws_s3_bucket_object" "slack_sns_email_usw2" {
...
module "sns_slack_usw2" {
  source = "../../modules/slack_sns/"

  sns_subscription_email_address_list = [data.aws_s3_bucket_object.slack_sns_email_usw2.body]
