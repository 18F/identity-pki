...
module "s3_inventory_uw2" {
  source = "github.com/18F/identity-terraform//s3_batch_inventory?ref=4c89d0487c41812020dcb10e31ba9def60517b83"
...
module "s3_config_ue1" {
  source = "github.com/18F/identity-terraform//state_bucket?ref=4c89d0487c41812020dcb10e31ba9def60517b83"
