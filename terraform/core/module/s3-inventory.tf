...
module "s3_inventory_uw2" {
  source = "github.com/18F/identity-terraform//s3_batch_inventory?ref=4c2fac72c84aa99590cc5690e04e55fc7a98872f"
...
module "s3_config_ue1" {
  source = "github.com/18F/identity-terraform//state_bucket?ref=4c2fac72c84aa99590cc5690e04e55fc7a98872f"
