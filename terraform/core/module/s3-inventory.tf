...
module "s3_inventory_uw2" {
  source = "github.com/18F/identity-terraform//s3_batch_inventory?ref=fe5cedbab370a69079261adb5e0ff1f7cd51acf8"
...
module "s3_config_ue1" {
  source = "github.com/18F/identity-terraform//state_bucket?ref=fe5cedbab370a69079261adb5e0ff1f7cd51acf8"
