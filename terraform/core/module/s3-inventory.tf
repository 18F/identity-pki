...
module "s3_inventory_uw2" {
  source = "github.com/18F/identity-terraform//s3_batch_inventory?ref=d1c01411db0bce308da5942a86bd2d548d902813"
...
module "s3_config_ue1" {
  source = "github.com/18F/identity-terraform//state_bucket?ref=d1c01411db0bce308da5942a86bd2d548d902813"
