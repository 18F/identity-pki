...
module "s3_inventory_uw2" {
  source = "github.com/18F/identity-terraform//s3_batch_inventory?ref=6cdd1037f2d1b14315cc8c59b889f4be557b9c17"
...
module "s3_config_ue1" {
  source = "github.com/18F/identity-terraform//state_bucket?ref=6cdd1037f2d1b14315cc8c59b889f4be557b9c17"
