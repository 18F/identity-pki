...
module "s3_shared" {
  source = "github.com/18F/identity-terraform//s3_bucket_block?ref=af60fa023799d7f14c9f0f78ebaeb0bb6b2d7b5c"
...
module "elb-logs" {
  ...
  source = "github.com/18F/identity-terraform//elb_access_logs_bucket?ref=af60fa023799d7f14c9f0f78ebaeb0bb6b2d7b5c"
