...
module "s3_shared" {
  source = "github.com/18F/identity-terraform//s3_bucket_block?ref=8f0abe0e3708e2c1ef1c1653ae2b57b378bf8dbf"
...
module "elb-logs" {
  ...
  source = "github.com/18F/identity-terraform//elb_access_logs_bucket?ref=8f0abe0e3708e2c1ef1c1653ae2b57b378bf8dbf"
