...
module "s3_shared" {
  source = "github.com/18F/identity-terraform//s3_bucket_block?ref=91eadab865ca59a2998387681ca83ac401b7c352"
...
module "elb-logs" {
  ...
  source = "github.com/18F/identity-terraform//elb_access_logs_bucket?ref=91eadab865ca59a2998387681ca83ac401b7c352"
