...
module "s3_shared" {
  source = "github.com/18F/identity-terraform//s3_bucket_block?ref=d1c01411db0bce308da5942a86bd2d548d902813"
...
module "elb-logs" {
  ...
  source = "github.com/18F/identity-terraform//elb_access_logs_bucket?ref=d1c01411db0bce308da5942a86bd2d548d902813"
