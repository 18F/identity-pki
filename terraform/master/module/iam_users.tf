...
resource "aws_iam_policy_attachment" "prod_secops_full_administrator" {
  name = "prod_secops_full_administrator"
  users = [
    aws_iam_user.mossadeq_zia.name,
    aws_iam_user.steven_harms.name,
    aws_iam_user.timothy_spencer.name,
  ]
  policy_arn = aws_iam_policy.prod_secops_assume_full_administrator.arn
}

resource "aws_iam_policy_attachment" "dev_secops_full_administrator" {
  name = "dev_secops_full_administrator"
  users = [
    aws_iam_user.mossadeq_zia.name,
    aws_iam_user.steven_harms.name,
    aws_iam_user.timothy_spencer.name,
  ]
  policy_arn = aws_iam_policy.dev_secops_assume_full_administrator.arn
}

resource "aws_iam_policy_attachment" "interviews_full_administrator" {
  name = "interviews_full_administrator"
  users = [
    aws_iam_user.mossadeq_zia.name,
    aws_iam_user.steven_harms.name,
    aws_iam_user.timothy_spencer.name,
  ]
  policy_arn = aws_iam_policy.interviews_assume_full_administrator.arn
}
