...
variable "attemptapi_low_success_alarm_threshold" {
  description = "Minimum number of IRS Attempt API Event calls per 30 minutes"
  type        = number
  default     = 1
}
