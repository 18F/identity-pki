...
variable "base_ami_sandbox_uw2" {
  default     = "ami-07563ea476c8ddc14" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
...
variable "base_ami_prod_uw2" {
  default     = "ami-0f0228bc4ee751f0c" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
...
variable "rails_ami_sandbox_uw2" {
  default     = "ami-01a57bf5772da58d6" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
...
variable "rails_ami_prod_uw2" {
  default     = "ami-0b57b8fcda303954c" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
...
variable "base_ami_sandbox_ue1" {
  default     = "ami-0012f6b2a7e3cd8ad" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
...
variable "rails_ami_sandbox_ue1" {
  default     = "ami-0dc7c84dc85047b8b" # 2024-10-15 Ubuntu 20.04
  description = <<EOM
