module "dashboard-idv-verify-your-identity-overview" {
  ...
  #
  #   aws-vault exec prod-power -- bin/copy-cloudwatch-dashboard --in prod-idv-verify-your-identity-overview --out cloudwatch-idv-verify-your-identity-overview.tf
  #
