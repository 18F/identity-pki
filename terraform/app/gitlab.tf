...
module "gitlab" {
  ...
  endpoint_subnet_ids     = slice([for subnet in module.network_usw2.app_subnet : subnet.id], 0, 2)
  vpc_id                  = module.network_usw2.vpc_id
  name                    = var.name
  env_name                = var.env_name
  allowed_security_groups = [module.network_usw2.base_id]
...
module "env-runner" {
  ...
  aws_vpc                          = module.network_usw2.vpc_id
  ...
  runner_subnet_ids                = [for subnet in module.network_usw2.app_subnet : subnet.id]
  s3_prefix_list_id                = module.network_usw2.s3_prefix_list_id
  s3_secrets_bucket_name           = data.aws_s3_bucket.secrets.bucket
  slack_events_sns_hook_arn        = var.slack_events_sns_hook_arn
  endpoint_security_groups = [
    module.network_usw2.endpoint_sg["kms"],
    module.network_usw2.endpoint_sg["ssm"],
    module.network_usw2.endpoint_sg["ssmmessages"],
    module.network_usw2.endpoint_sg["ec2"],
    module.network_usw2.endpoint_sg["ec2messages"],
    module.network_usw2.endpoint_sg["logs"],
    module.network_usw2.endpoint_sg["monitoring"],
    module.network_usw2.endpoint_sg["secretsmanager"],
    module.network_usw2.endpoint_sg["sts"],
    module.network_usw2.endpoint_sg["events"],
    module.network_usw2.endpoint_sg["sns"],
    module.network_usw2.endpoint_sg["lambda"],
    module.network_usw2.endpoint_sg["sqs"],
    module.network_usw2.endpoint_sg["dms"]
  ]
