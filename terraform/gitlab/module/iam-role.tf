  ...
  "Statement": [
      {
          ...
          "Resource": [
              ...
              "arn:aws:s3:::login-gov-${var.env_name}-gitlabbackups-${data.aws_caller_identity.current.account_id}-${var.dr_region}",
              "arn:aws:s3:::login-gov-${var.env_name}-gitlabediffs-${data.aws_caller_identity.current.account_id}-${var.region}",
              ...
              "arn:aws:s3:::login-gov-${var.env_name}-gitlabdproxy-${data.aws_caller_identity.current.account_id}-${var.region}",
