...
variable "idp_iam_role_arn" {
  type        = string
  description = "ARN of the role used by idp hosts in the account"
}

variable "migration_iam_role_arn" {
  type        = string
  description = "ARN of the role used by migration hosts in the account"
}
