...
import {
  ...
  id = "Detect-if-CloudTrail-is-disabled-rLambdaCTRole-1CHNH3F05TOKJ"
}

import {
  to = module.main.aws_iam_role_policy.fn_CloudTrailResponder_lambda
  id = "Detect-if-CloudTrail-is-disabled-rLambdaCTRole-1CHNH3F05TOKJ:rLambdaCTRole"
}
...
import {
  ...
  id = "Detect-if-CloudTrail-is-disabled-rEventRule-1HANCC7MEMGLU"
}

import {
  to = module.main.aws_cloudwatch_event_target.target_fn_CloudTrailResponder
  id = "Detect-if-CloudTrail-is-disabled-rEventRule-1HANCC7MEMGLU/TargetFunctionV1"
}

import {
  to = module.main.aws_lambda_permission.cloudwatch_to_fn_CloudTrailResponder
  id = "arn:aws:lambda:us-west-2:894947205914:function:fn_CloudTrailResponder/Detect-if-CloudTrail-is-disabled-rPermissionForEventsToInvokeLambda-SRQ2OFGPUXHR"
}
