...
execute 'reload_systemd' do
	command "chown -R newrelic_infra: /tmp/nr-integrations /var/db/newrelic-infra /var/run/newrelic-infra ; echo systemctl reload newrelic-infra ; systemctl restart newrelic-infra"
	action :nothing
end
