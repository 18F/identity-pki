...
execute 'reload_systemd' do
	command "chown -R newrelic_infra: /tmp/nr-integrations /var/db/newrelic-infra /var/run/newrelic-infra ; systemctl daemon-reload ; sleep 5 ; systemctl restart newrelic-infra"
	action :nothing
end
