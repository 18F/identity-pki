...
default['identity_gitlab']['gitlab_version'] = '17.3.4-ee.0' # https://packages.gitlab.com/gitlab/gitlab-ee
default['identity_gitlab']['gitlab_runner_version'] = '17.3.1-1' # https://packages.gitlab.com/runner/gitlab-runner
