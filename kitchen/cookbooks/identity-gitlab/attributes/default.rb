...
default['identity_gitlab']['gitlab_version'] = '16.7.2-ee.0' # https://packages.gitlab.com/gitlab/gitlab-ee
default['identity_gitlab']['gitlab_runner_version'] = '16.7.0' # https://packages.gitlab.com/runner/gitlab-runner
