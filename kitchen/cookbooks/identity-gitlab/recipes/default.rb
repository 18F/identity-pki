...
gitlab_version = '15.8.2-ee.0' # https://packages.gitlab.com/gitlab/gitlab-ee
...
target_url = if node.chef_environment == 'production' or node.chef_environment == 'gitstaging'
