...
action :create do
  ...
  template "#{name}/config/application.yml" do
    ...
    variables({
      ...
      exception_recipients: ConfigLoader.load_config(node, "exception_recipients"),
      ...
      issuers_with_email_nameid_format: ConfigLoader.load_config_or_nil(node, "issuers_with_email_nameid_format") || '',
      ...
      usps_confirmation_max_days: node.fetch('login_dot_gov').fetch('usps_confirmation_max_days'),
