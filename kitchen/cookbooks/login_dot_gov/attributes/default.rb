...
default['login_dot_gov']['nginx_server_names_hash_configurations']    = false
default['login_dot_gov']['nginx_server_names_hash_bucket_size']       = 128
default['login_dot_gov']['nginx_server_names_hash_max_size']          = 512
...
# these as their primary role (e.g. 'outboundproxy').
...
when /\A48731/
  default['login_dot_gov']['domain_name'] = 'analytics.identitysandbox.gov'
when /\A03479/
...
default['login_dot_gov']['static_cdn_max_age'] = 31_536_000
...
default['login_dot_gov']['sp_rails']['saml_issuer'] =
  "urn:gov:gsa:SAML:2.0.profiles:sp:sso:rails-#{node.chef_environment}"

# PivCac: Allow filtering Cert available for users
default['login_dot_gov']['use_client_certificate'] = false

# dashboard
default['login_dot_gov']['dashboard']['sp_certificate'] =
...
default['login_dot_gov']['dashboard']['sp_private_key'] =
