...
default['login_dot_gov']['ruby_version']                              = '2.3.5'
...
default['login_dot_gov']['aws_kms_key_id']                            = 'DEFAULT-CHANGE-ME'
default['login_dot_gov']['domain_name']                               = 'login.gov'
default['login_dot_gov']['dashboard_api_token']                       = ''
default['login_dot_gov']['disable_email_sending']                     = 'false'
...
default['login_dot_gov']['enable_load_testing_mode']                  = 'false'
default['login_dot_gov']['enable_usps_verification']                  = 'false'
default['login_dot_gov']['enable_test_routes']                        = 'false'
default['login_dot_gov']['equifax_avs_username']                      = ''
default['login_dot_gov']['equifax_eid_username']                      = ''
default['login_dot_gov']['equifax_endpoint']                          = ''
default['login_dot_gov']['equifax_gpg_email']                         = 'donny.whitten@fisglobal.com'
default['login_dot_gov']['equifax_password']                          = ''
default['login_dot_gov']['equifax_phone_username']                    = ''
default['login_dot_gov']['equifax_sftp_directory']                    = '/fis/tst/incoming/'
default['login_dot_gov']['equifax_sftp_host']                         = 'securetransport.ec.equifax.com'
...
default['login_dot_gov']['mandrill_api_token']                        = 'super-secret-monkey-token'
default['login_dot_gov']['max_mail_events']                           = '4'
default['login_dot_gov']['max_mail_events_window_in_days']            = '30'
...
default['login_dot_gov']['otp_delivery_blocklist_maxretry']           = '10'
...
default['login_dot_gov']['queue_health_check_dead_interval_seconds']  = '60'
default['login_dot_gov']['queue_health_check_frequency_seconds']      = '30'
default['login_dot_gov']['reauthn_window']                            = '120'
default['login_dot_gov']['recovery_code_length']                      = '4'
...
default['login_dot_gov']['telephony_disabled']                        = 'false'
...
default['login_dot_gov']['sp_rails']['idp_slo_url'] = 'https://idp.<%= ENV["SAML_ENV"] || warn("missing SAML_ENV in ENV") %>.login.gov/api/saml/logout'
default['login_dot_gov']['sp_rails']['idp_sso_url'] = 'https://idp.<%= ENV["SAML_ENV"] || warn("missing SAML_ENV in ENV") %>.login.gov/api/saml/auth'
default['login_dot_gov']['sp_rails']['saml_issuer'] = 'urn:gov:gsa:SAML:2.0.profiles:sp:sso:rails-<%= ENV["SAML_ENV"] || warn("missing SAML_ENV in ENV") %>'
default['login_dot_gov']['sp_rails']['secret_key_base'] = '<%= ENV["SECRET_KEY_BASE"] || warn("missing SECRET_KEY_BASE in ENV") %>'
default['login_dot_gov']['sp_rails']['acs_url'] = 'https://sp.<%= ENV["SAML_ENV"] || warn("missing SAML_ENV in ENV") %>.login.gov/auth/saml/callback'
