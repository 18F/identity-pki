...
runcmd:
 - /var/lib/cloud/instance/scripts/provision.sh --kitchen-subdir kitchen --berksfile-toplevel --chef-download-url "${chef_download_url}" --chef-download-sha256 "${chef_download_sha256}" --git-ref "${main_git_ref}" "${main_s3_ssh_key_url}" "${main_git_clone_url}" || echo 'MAIN CHEF RUN FAILED'
